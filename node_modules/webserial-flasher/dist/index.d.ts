...
export type { Board, V2ISPParams, STK500Options, RetryOptions, StageTimeouts, BootloadProgressCallback, LogLevel, Logger, } from './core/types.js';
export { STK500ErrorCode, STK500Error, STK500SyncError, STK500SignatureMismatchError, STK500VerifyError, STK500TimeoutError, STK500ProtocolError, STK500InvalidHexError, STK500PortError, } from './core/errors.js';
...
export { BOARDS, boardFromFqbn, detectBoardBySignature, ARDUINO_USB_VENDOR_IDS, } from './boards/database.js';
